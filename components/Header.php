      ...
      <div class="position-relative">
        <div class="row" style="align-items: center;">
          <div class="col-lg-3 col-md-12 d-flex align-items-center justify-content-between">
            <a id="logo" href="./" class="d-inline-block margin-tb-15px"><img src="./logo.png" width="100" alt=""></a>
                ...
                <div class="contact-info opacity-9">
                  <div class="d-flex">
                    ...
                    <div class="text m">
                      ...
                      <span class="font-weight-500 text-uppercase text-main-color">
                        Al Ghayath St 28,
                      </span> <br>
                      <span class="font-weight-500 text-uppercase text-main-color">
                        Abu Dhabi,
              ...
              <div class="col-lg-4 padding-tb-15px">
                <div class="contact-info opacity-9">
                  ...
                  <div class="text">
                    ...
                    <a href="https://api.whatsapp.com/send?phone=17572352012&text=Hi%2C%20my%20name%20is%20____.%20I%20want%20to%20make%20an%20enquiry%20about%20https%3A%2F%2Fdash-delivery.com" class="font-weight-500 text-uppercase text-main-color">+17572352012</a>
                  </div>
                </div>
              </div>
              <!-- // contact info -->
