      ...
      <div class="col-lg-4 col-md-6">
        <div class="about-us sm-mb-45px">
          <div class="logo-footer margin-bottom-35px">
            <a href="#"><img src="./logo.png" width="150" alt=""></a>
          </div>
          <div class="text margin-bottom-35px">
          Dash Delivery is your trusted logistics partner, offering swift and reliable transportation solutions. With a customer-centric approach and advanced tracking systems, we guarantee timely and secure deliveries. Experience hassle-free logistics with our dedicated team and state-of-the-art services.
          </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="copy-right-text text-lg-left text-center sm-mb-15px">
            ...
            <a target="_blank" href="">Dash-Delivery</a> 
          </div>
        </div>
        <div class="col-lg-6">
          <!--  Social -->
