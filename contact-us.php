    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 sm-mb-45px">
          <p>For prompt and personalized logistics solutions, reach out to Dash Delivery. Fill out the contact form below and experience reliable deliveries with a team dedicated to your satisfaction.</p>
          <h5>Phone :</h5>
