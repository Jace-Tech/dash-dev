...
$DELIVERED_PARCELS = listDeliveredParcels();
?>
<!doctype html>
<html lang="en">
...
<head>
  <meta charset="utf-8">
  <title>ADMIN DSD - Dashboard</title>
      ...
      <main>
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="grid grid-cols-12 gap-6">
            ...
            <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-gray-200">
              <div class="px-5 py-5">
                <h2 class="text-lg text-indigo-600 font-semibold mb-2">Claimed Parcels</h2>
                <div class="text-xs font-semibold text-gray-400 uppercase mb-1">Total claimed parcels</div>
                <div class="flex items-start">
                  <div class="text-3xl font-bold mr-2"><?= count($DELIVERED_PARCELS); ?></div>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-gray-200">
              <div class="px-5 py-5">
                <h2 class="text-lg text-indigo-600 font-semibold mb-2">Unclaimed Parcels</h2>
            ...
            <div class="col-span-full bg-white shadow-lg rounded-sm border border-gray-200">
              <header class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                ...
                <a href="./view-parcel" class="text-xs hover:underline hover:text-indigo-500 font-semibold text-indigo-400">See more</a>
              </header>
              <div class="p-3">
                  ...
                  <table class="table-auto w-full">
                    <thead class="text-xs uppercase text-gray-400 bg-gray-50 rounded-sm">
                      <tr>
                        ...
                        <th class="p-2 whitespace-nowrap">
                          <div class="font-semibold text-center">From</div>
                        </th>
                        <th class="p-2 whitespace-nowrap">
                          <div class="font-semibold text-center">To</div>
                        </th>
                      ...
                      <?php if (count($ALL_PARCELS)) : ?>
                        <?php foreach ($ALL_PARCELS as $parcel) : ?>
                          <tr class="text-xs">
                            ...
                            <td class="p-2 whitespace-nowrap">
                              <div class="text-center"><?= $parcel['size'] ?></div>
                            </td>
                            <td class="p-2 whitespace-nowrap">
                            ...
                            <td class="p-2 whitespace-nowrap">
                              <div class="text-center"><?= $parcel['from'] ?></div>
                            </td>
                            <td class="p-2 whitespace-nowrap">
                              <div class="text-center"><?= $parcel['to'] ?></div>
                            </td>

                            <td class="p-2">
                              <div class="items-center gap-4 flex">
                                <?php if(strchr(strtolower($parcel['status']), "not")): ?>
                                  <a href="./handler/parcel.handler?claim-parcel=<?= $parcel['id'] ?>" class="btn btn-xs text-xs whitespace-nowrap text-white bg-indigo-500 hover:bg-indigo-600">Mark Claimed</a>
                                <?php else: ?>
                                  <a href="./handler/parcel.handler?unclaim-parcel=<?= $parcel['id'] ?>" class="btn btn-xs text-xs whitespace-nowrap text-white bg-yellow-500 hover:bg-yellow-600">Mark Unclaimed</a>
                                <?php endif; ?>
